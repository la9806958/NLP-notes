...
FEATURES_DIR = "/home/lichenhui/transformed_features/"
RETURNS_ROOT = "/home/lichenhui"   # folder that contains year sub-dirs
...
def load_model_and_evaluate(model_name, features, device='cuda'):
    ...
    Model path: /home/lichenhui/DeepLOB_new/{model_name}/Full_model_{model_name}.pth
    ...
    Returns:
        prediction_dict: {(ticker, datetime): {'x':..., 'y':..., 'pred':...}}
    """
    checkpoint_path = f"/home/lichenhui/{model_name}/Full_model_{model_name}.pth"
